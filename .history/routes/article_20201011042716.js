...
router.get('/?:page', async (req, res) => {
  ...
  const navBarIndexLimit = 4; // how many page indexes to show in navigation bar < 1 2 3 4 >
  const navBarIndexOffset = Math.floor(page / navBarIndexLimit); // skip previous indexes < 5 6 7 8 >
  ...
  Object.keys(articles.rows).forEach((key) => {
