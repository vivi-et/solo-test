...
// console.log(makeNavbarIndexArr(0, 6));
...
router.get('/?:currentPage', (req, res) => {
  const { currentPage, itemsPerPage = 3 } = req.params;
  const offset = currentPage ? (currentPage - 1) * itemsPerPage : 1; // skip previous items
